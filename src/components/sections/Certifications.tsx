...
const certifications = [
  {
    ...
    detail:
      "Successfully completed and received a passing grade in Data Analysis with Python. Issued September 11, 2026.",
    variant: "blue" as const,
    link: "https://courses.cognitiveclass.ai/certificates/900e7250b10f4bd38a1cfc6c74e4ea03",
  },
  {
    title: "SQL and Relational Databases 101",
    subtitle: "IBM Skills Network / Cognitive Class",
    detail:
      "Successfully completed and received a passing grade in SQL and Relational Databases 101. Issued September 11, 2026.",
    variant: "yellow" as const,
    link: "https://courses.cognitiveclass.ai/certificates/c1840185ff7c4952a3344abd76c37b3a",
  },
  {
        ...
        {certifications.map((cert, index) => (
          ...
          >
            <Card variant="white" shadowColor={cert.variant} tilt className="p-7 h-full">
              ...
              <p className="font-space text-base font-black uppercase mt-3">
                {cert.subtitle}
              </p>
              ...
              {cert.link && (
                <div className="mt-6">
                  <a
                    ...
                    className="font-space text-xs font-black uppercase underline hover:no-underline"
                  >
                    Verify Certificate ↗
                  </a>
                </div>
