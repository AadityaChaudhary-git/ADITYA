      ...
      > 
        ...
        <motion.div variants={itemVariants} className="lg:col-span-5 flex flex-col gap-6"> 
          <div className="grid grid-cols-2 gap-4"> 
            <Card variant="yellow" tilt className="p-4 flex flex-col justify-between items-start min-h-[140px] hover:rotate-[-2deg]"> 
              <GraduationCap className="h-6 w-6" /> 
              <div> 
                <h4 className="font-space text-3xl font-black">MCA</h4> 
                <p className="font-space text-xs font-black uppercase text-neutral-600">2026–2028</p> 
              </div> 
            </Card> 
 
            <Card variant="red" tilt className="p-4 flex flex-col justify-between items-start min-h-[140px] hover:rotate-[2deg]"> 
              <Database className="h-6 w-6 text-white" /> 
              <div> 
                <h4 className="font-space text-3xl font-black text-white">DATA</h4> 
                <p className="font-space text-xs font-black uppercase text-neutral-200">Analytics Focus</p> 
              </div> 
            </Card> 
 
            <Card variant="purple" tilt className="p-4 flex flex-col justify-between items-start min-h-[140px] hover:rotate-[2deg]"> 
              <Code className="h-6 w-6" /> 
              <div> 
                <h4 className="font-space text-3xl font-black">BCA</h4> 
                <p className="font-space text-xs font-black uppercase text-neutral-600">7.6 / 10 CGPA</p> 
              </div> 
            </Card> 
 
            <Card variant="green" tilt className="p-4 flex flex-col justify-between items-start min-h-[140px] hover:rotate-[-2deg]"> 
              <Brain className="h-6 w-6" /> 
              <div> 
                <h4 className="font-space text-3xl font-black">ML</h4> 
                <p className="font-space text-xs font-black uppercase text-neutral-600">Learning & Building</p> 
              </div> 
            </Card> 
          </div> 
          ...
          {/* RESUME */} 
          <Card variant="white" className="p-5 border-dashed flex items-center justify-between gap-4"> 
            <div className="flex flex-col"> 
              <h4 className="font-space text-lg font-black uppercase">RESUME.PDF</h4> 
